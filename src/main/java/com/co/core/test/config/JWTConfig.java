package com.co.core.test.config;
...
public class JWTConfig extends AuthorizationServerConfigurerAdapter{
	...
	@Value("${pepe.oauth.tokenTimeout:3600}")
	...
	public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
		...
		clients.inMemory().withClient("pepe").secret("sierra1*").accessTokenValiditySeconds(expiration)
